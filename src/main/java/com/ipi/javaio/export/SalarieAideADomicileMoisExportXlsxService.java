...
public class SalarieAideADomicileMoisExportXlsxService {
    ...
    public void export(ServletOutputStream outputStream) throws IOException {
        ...
        cellHeaderJourTravaillesAnneeN.setCellValue("Jours travaillés par année");
        ...
        cellHeaderCongesPayesAcquisAnneeN.setCellValue("Congés payés acquis par année");
        ...
        for (SalarieAideADomicileMois mois : allMois) {
            ...
            Cell cellJourTravailleAnnee = row.createCell(COL_JOUR_TRAVAILLES_ANNEE_N);
            cellJourTravailleAnnee.setCellValue(salarie.getJoursTravaillesAnneeN());
            cellJourTravailleAnnee.setCellStyle(styleHeader);

            Cell cellCongesPayesAcquisAnnee = row.createCell(COL_CONGES_PAYES_ACQUIS_ANNEE_N);
            cellCongesPayesAcquisAnnee.setCellValue(salarie.getCongesPayesAcquisAnneeN());
            cellCongesPayesAcquisAnnee.setCellStyle(styleHeader);
        ...
        enteteMoisDebutContrat.setCellValue("Mois de début de contrat");
        ...
        Cell entetejoursTravaillesAnnee = entete.createCell(4); // 0
        entetejoursTravaillesAnnee.setCellValue("Jours travaillés par années");
        entetejoursTravaillesAnnee.setCellStyle(styleHeader);
        ...
        enteteJeannetteMDC.setCellValue("Mois de début de contrat");
        ...
        enteteJeannetteJoursTravailles.setCellValue("Jours travaillés par année");
        ...
        for (SalarieAideADomicile salarie : salaries ) {
            ...
            if ( id == 1) {
                ...
                Cell cellJoursTravaillesAnnee = line.createCell(4);
                cellJoursTravaillesAnnee.setCellValue(salarie.getJoursTravaillesAnneeN());
                cellJoursTravaillesAnnee.setCellStyle(styleHeader);
            } else if (id == 8) {
